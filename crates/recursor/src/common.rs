...
use hickory_proto::{op::Query, xfer::DnsResponse};
use hickory_resolver::{dns_lru::DnsLru, lookup::Lookup, Name};
...
pub(crate) fn insert_response(
    ...
    let mut r = response.into_message();
...
pub(crate) fn maybe_strip_dnssec_records(
